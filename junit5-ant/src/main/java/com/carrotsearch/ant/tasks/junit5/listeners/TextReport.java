...
import static com.carrotsearch.ant.tasks.junit5.FormattingUtils.*;
...
import com.carrotsearch.ant.tasks.junit5.Pluralize;
...
import com.carrotsearch.ant.tasks.junit5.events.aggregated.AggregatedResultEvent;
import com.carrotsearch.ant.tasks.junit5.events.aggregated.AggregatedStartEvent;
import com.carrotsearch.ant.tasks.junit5.events.aggregated.AggregatedSuiteResultEvent;
import com.carrotsearch.ant.tasks.junit5.events.aggregated.AggregatedSuiteStartedEvent;
...
import com.carrotsearch.ant.tasks.junit5.events.aggregated.HeartBeatEvent;
...
public class TextReport implements AggregatedEventListener {
  ...
  /**
   * Initialization by container task {@link JUnit5}.
   */
  @Override
  @SuppressForbidden("legitimate sysstreams.")
  public void setOuter(JUnit5 task) {
