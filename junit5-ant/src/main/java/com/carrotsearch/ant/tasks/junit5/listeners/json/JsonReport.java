package com.carrotsearch.ant.tasks.junit5.listeners.json;
...
public class JsonReport implements AggregatedEventListener {
   ...
   */
  @Override
  public void setOuter(JUnit5 junit4) {
    this.junit4 = junit4;
  ...
  private void copyScaffolding(File targetFile) throws IOException {
    String resourcePrefix = "com/carrotsearch/ant/tasks/junit5/templates/json/";
