...
public class TestMiscJUnit5Attributes extends JUnit5XmlTestBase {
  ...
  public void balancing() {
    ...
    assertLogContains("Assignment hint: J0  (cost  2019) com.carrotsearch.ant.tasks.junit5.tests.sub2.TestTwoSeconds (by ExecutionTimeBalancer)");
    assertLogContains("Assignment hint: J1  (cost  1002) com.carrotsearch.ant.tasks.junit5.tests.sub2.TestOneSecond (by ExecutionTimeBalancer)");
    assertLogContains("Assignment hint: J1  (cost   501) com.carrotsearch.ant.tasks.junit5.tests.sub2.TestHalfSecond (by ExecutionTimeBalancer)");
    assertLogContains("Assignment hint: J1  (cost     2) com.carrotsearch.ant.tasks.junit5.tests.sub2.TestZeroSeconds (by ExecutionTimeBalancer)");
  }
